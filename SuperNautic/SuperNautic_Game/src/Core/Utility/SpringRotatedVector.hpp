...
class SpringRotatedVector {
 public:
  SpringRotatedVector(const glm::vec3& vector, const glm::vec3& target,
                      const glm::vec3& backupAxis, float springConstant,
 ...
 protected:
  ...
  // If true, only allow _vector to be orthogonal to and rotate around
  // _backupAxis
  bool _lockedToAxis;
};
