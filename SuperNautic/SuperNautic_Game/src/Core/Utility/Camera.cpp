...
Camera::Camera(float fov, int viewWidth, int viewHeight, const glm::vec3& pos,
  ...
  _perspective = glm::perspective(
      glm::radians(_fov), (float)_viewWidth / _viewHeight, 0.1f, 1000.f);
...
glm::vec3 Camera::getDirection() const { return _viewDir; }
...
glm::mat4 Camera::getPerspective() const { return _perspective; }

// Returns the view-perspective-matrix
glm::mat4 Camera::getVP() const { return _perspective * _view; }
