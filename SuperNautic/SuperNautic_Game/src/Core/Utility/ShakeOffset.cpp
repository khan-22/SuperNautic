...
ShakeOffset::ShakeOffset(float horizontalSpeed, float horizontalMagnitude, float verticalSpeed, float verticalMagnitude, float decaySpeed, float baseShakeSpeed)
	: _horizontalSpeed{ horizontalSpeed }, _horizontalMagnitude{ horizontalMagnitude }, _verticalSpeed{ verticalSpeed }, _verticalMagnitude{ verticalMagnitude }, _baseSpeed{ baseShakeSpeed },
	  _decaySpeed{ decaySpeed }, _hAccumulator{ 0.0f }, _vAccumulator{ 0.0f }, _shakeMagnitude{ 0.0f }, _shakeSpeed{ 0.0f }
{
}
...
glm::vec3 ShakeOffset::getVector() const
{
	return glm::vec3{ sinf(_hAccumulator) * _horizontalMagnitude * _shakeMagnitude,
					  sinf(_vAccumulator) * _verticalMagnitude * _shakeMagnitude, 0.0f };
}

glm::vec3 ShakeOffset::operator()() const
{
	return getVector();
}
...
void ShakeOffset::setDecaySpeed(float decaySpeed)
{
