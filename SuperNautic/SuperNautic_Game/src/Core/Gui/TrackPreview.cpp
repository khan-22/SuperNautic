...
TrackPreview::TrackPreview(Track& track) { setTrack(track); }

void TrackPreview::render(GFX::RenderStates& states) { _track.render(states); }
...
void TrackPreview::move(const glm::vec2& xy) { _track.move(xy); }
