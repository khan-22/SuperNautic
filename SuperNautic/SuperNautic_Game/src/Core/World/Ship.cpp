...
Ship::Ship(glm::vec3 color)
        ...
        _meshForwardDirection{ glm::vec3{ 0.0f, 0.0f, 1.0f }, glm::vec3{ 0.0f,
0.0f, 1.0f }, glm::vec3{ 0.0f, 1.0f, 0.0f }, 800.0f, 20.0f, false },
        _meshUpDirection{ glm::vec3{ 0.0f, 1.0f, 0.0f }, glm::vec3{ 0.0f, 1.0f,
0.0f }, glm::vec3{ 0.0f, 0.0f, 1.0f }, 60.0f, 9.0f, true }, _cameraUpDirection{
glm::vec3{ 0.0f, 1.0f, 0.0f }, glm::vec3{ 0.0f, 1.0f, 0.0f }, glm::vec3{ 0.0f,
0.0f, 1.0f }, 20.0f, 10.0f, true }, _cameraForwardDirection{ glm::vec3{ 0.0f,
0.0f, 1.0f }, glm::vec3{ 0.0f, 0.0f, 1.0f }, glm::vec3{ 0.0f, 1.0f, 0.0f },
100.0f, 10.0f, false }, _meshPosition{ glm::vec3{ 0.0f, 0.0f, 0.0f }, glm::vec3{
0.0f, 0.0f, 0.0f }, glm::vec3{ 0, 1, 0 }, 5.0f, 100.0f }, _minAcceleration{ 0.0f
}, _maxAcceleration{ 100.0f }, _maxTurningSpeed{ 20.0f },
        ...
        _boundingBox{ glm::vec3{ 0.0f }, std::array<glm::vec3, 3>{
glm::vec3{ 1.0f, 0.0f, 0.0f }, glm::vec3{ 0.0f, 1.0f, 0.0f }, glm::vec3{ 0.0f,
0.0f, 1.0f } }, std::array<float, 3>{ 1.0f, 0.5f, 1.0f } },
...
{
        move(0, 0, 100);
        _shipModel = GFX::TexturedModel(ModelCache::get("ship.kmf"),
MaterialCache::get("test.mat"));

        setInactiveTime(_inactiveAtStart);

        _particleSystem.init(600, glm::vec3(0.f), glm::vec3(0.f, 0.f, 0.f),
0.5f, 7.f, 50.f); _particleSystem.start();

        _leftChemtrailParticleSystem.init(600, glm::vec3(0.f), glm::vec3(0.f),
0.2f, 0.f, 0.f); _leftChemtrailParticleSystem.start();
        _rightChemtrailParticleSystem.init(600, glm::vec3(0.f), glm::vec3(0.f),
0.2f, 0.f, 0.f); _rightChemtrailParticleSystem.start();
}
*/
Ship::Ship(glm::vec3 color, int shipId)
    : _shipId{shipId},
      ...
      _shipForward{0.0f, 0.0f, 1.0f},
      _upDirection{0.0f, 1.0f, 0.0f},
      _meshForwardDirection{glm::vec3{0.0f, 0.0f, 1.0f},
                            glm::vec3{0.0f, 0.0f, 1.0f},
                            glm::vec3{0.0f, 1.0f, 0.0f},
                            800.0f,
                            20.0f,
                            false},
      _meshUpDirection{glm::vec3{0.0f, 1.0f, 0.0f},
                       glm::vec3{0.0f, 1.0f, 0.0f},
                       glm::vec3{0.0f, 0.0f, 1.0f},
                       60.0f,
                       9.0f,
                       true},
      _cameraUpDirection{glm::vec3{0.0f, 1.0f, 0.0f},
                         glm::vec3{0.0f, 1.0f, 0.0f},
                         glm::vec3{0.0f, 0.0f, 1.0f},
                         20.0f,
                         10.0f,
                         true},
      _cameraForwardDirection{glm::vec3{0.0f, 0.0f, 1.0f},
                              glm::vec3{0.0f, 0.0f, 1.0f},
                              glm::vec3{0.0f, 1.0f, 0.0f},
                              100.0f,
                              10.0f,
                              false},
      _meshPosition{glm::vec3{0.0f, 0.0f, 0.0f}, glm::vec3{0.0f, 0.0f, 0.0f},
                    glm::vec3{0, 1, 0}, 5.0f, 100.0f},
      ...
      _bEngineOverload{false},
      _bObstacleCollision{false},
      _boundingBox{glm::vec3{0.0f},
                   std::array<glm::vec3, 3>{glm::vec3{1.0f, 0.0f, 0.0f},
                                            glm::vec3{0.0f, 1.0f, 0.0f},
                                            glm::vec3{0.0f, 0.0f, 1.0f}},
                   std::array<float, 3>{1.0f, 0.5f, 1.0f}},
      _cooldownOnObstacleCollision{2.0f},
      _immunityOnObstacleCollision{4.0f},
      _immunityTimer{0.0f},
      _blinkFrequency{0.1f},
  ...
  _particleSystem.init(600, glm::vec3(0.f), glm::vec3(0.f, 0.f, 0.f), 0.5f, 7.f,
                       50.f);
  _particleSystem.start();

  _leftChemtrailParticleSystem.init(600, glm::vec3(0.f), glm::vec3(0.f), 0.2f,
                                    0.f, 0.f);
  _leftChemtrailParticleSystem.start();
  _rightChemtrailParticleSystem.init(600, glm::vec3(0.f), glm::vec3(0.f), 0.2f,
                                     0.f, 0.f);
  _rightChemtrailParticleSystem.start();
}
Ship::Ship(glm::vec3 color, float maxAcceleration, float maxTurningSpeed,
           float cooldownOnObstacleCollision, float overheatTemperature,
           float overhearCooldown)
    : _destroyed{false},
      _stopped{false},
      _turningFactor{0.0f},
      _currentTurningAngle{0.0f},
      ...
      _overheatCooldown{overhearCooldown},
      _warningLevel{0.8f},
      _warningLightIntensity{2.0f},
      _warningAccumulator{0.0f},
      _engineBlinkAccumulator{0.0f},
...
void Ship::update(float dt) {
  ...
  glm::vec3 bounceDirection{
      _bounceVector - glm::dot(_bounceVector, _upDirection) * _upDirection};
  if (!bAlmostEqual(bounceDirection, glm::vec3{0.0f})) {
    _bounceVector =
        glm::normalize(bounceDirection) * glm::length(_bounceVector);
    move(_bounceVector);
  }
  _bounceVector -= _bounceVector * _bounceDecay * dt;

  _shipCollisionShake.setMagnitude(_steeringCooldown /
                                   _cooldownOnObstacleCollision);
  ...
  _meshMatrix = {glm::vec4{glm::normalize(glm::cross(_meshUpDirection(),
                                                     _meshForwardDirection())),
                           0.0f},
  ...
  // Update matrix
  _transformMatrix =
      glm::translate(_meshPosition()) *
      glm::translate(
          glm::vec3{_meshMatrix * glm::vec4{_shipCollisionShake(), 0.0f}}) *
      _meshMatrix * glm::scale(getScale()) * glm::translate(-getOrigin());

  // Update bounding box
  _boundingBox.center = _meshPosition();
  _boundingBox.directions[0] =
      glm::normalize(glm::cross(_meshUpDirection(), _meshForwardDirection()));
...
void Ship::jump() {
  if (_currentJumpCooldown <= 0.0f && _steeringCooldown <= 0.0f &&
      _inactiveTimer <= 0.0f) {
    _jumping = true;
    _meshSpringValue.setValue(5.0f);

    glm::mat4 rotation = glm::rotate(glm::pi<float>(), _trackForward);

    _upDirection = rotation * glm::vec4{_upDirection, 0.0f};

    _upDirection = glm::normalize(
        _upDirection - glm::dot(_upDirection, _trackForward) * _trackForward);
...
void Ship::checkObstacleCollision() {
  ...
  for (SegmentInstance* segment : _segmentsToTest) {
    ...
    for (unsigned i = 0; !collided && i < segment->getObstacles().size(); ++i) {
      ...
      for (unsigned j = 0;
           !collided &&
           j < segment->getObstacles()[i].getBoundingBoxes().size();
           ++j) {
        BoundingBox& localBox =
            segment->getObstacles()[i].getBoundingBoxes()[j];

        // Transform the bounding box to global space
        BoundingBox globalBox;
        globalBox.halfLengths = localBox.halfLengths;
        globalBox.center = segment->getObstacles()[i].getModelMatrix() *
                           glm::vec4{localBox.center, 1.0f};
        globalBox.directions[0] = glm::normalize(
            glm::vec3{segment->getObstacles()[i].getModelMatrix() *
                      glm::vec4{localBox.directions[0], 0.0f}});
        globalBox.directions[1] = glm::normalize(
            glm::vec3{segment->getObstacles()[i].getModelMatrix() *
                      glm::vec4{localBox.directions[1], 0.0f}});
        globalBox.directions[2] = glm::normalize(
            glm::vec3{segment->getObstacles()[i].getModelMatrix() *
                      glm::vec4{localBox.directions[2], 0.0f}});

        // Test ship bounding box against obstacle's bounding box in global
        // space
...
float Ship::getOverheatTemperature() { return _overheatTemperature; }
...
void Ship::handleInputs(float dt) {
  if (!_stopped) {
    ...
    if (_steeringCooldown <= 0.0f && _inactiveTimer <= 0.0f) {
      ...
      // reduce maneuverability at high acceleration
      addToAngle = -_turningFactor * _maxTurningSpeed *
                   (1.0f - _accelerationFactor * 0.0f) * dt;
    } else {
      _accelerationFactor = -1.0f;
    }
    // abs to preserve sign of _currentTurningAngle
    float removeFromAngle =
        _steerStraighteningForce * _currentTurningAngle * dt;

    _currentTurningAngle += addToAngle - removeFromAngle;

    // Update velocity
    _velocity += (_minAcceleration +
                  _accelerationFactor * (_maxAcceleration - _minAcceleration)) *
                     dt -
                 (_velocity * _velocity * _speedResistance) * dt;
  } else {
    // Break if stopped
    _accelerationFactor = -1.0f;
...
void Ship::handleTemperature(float dt) {
  ...
  _engineTemperature +=
      (difference == 0.0f ? 1.0f : (std::fabs(difference) / difference)) *
      powf(std::fabs(difference), 1.2f) * 0.4f * dt;
  _engineTemperature = clamp(_engineTemperature, 0.0f, 1.0f);

  if (_engineTemperature > _overheatTemperature && _engineCooldown < 0.f) {
    _engineCooldown = _overheatCooldown;
    _bEngineOverload = true;
  }

  if (_engineCooldown > 0.0f) {
    _shipCollisionShake.setMagnitude(
        std::max(0.1f, _engineCooldown * 0.5f / _overheatCooldown));
    _shipCollisionShake.setSpeed(
        std::max(0.1f, _engineCooldown * 0.5f / _overheatCooldown));
  }
}
...
void Ship::rotateTowardTrackForward(float dt) {
  ...
  glm::vec3 rotateTowards = glm::normalize(
      _trackForward - glm::dot(_trackForward, _upDirection) * _upDirection);
  ...
  // Rotate direction
  glm::mat4 forwardRotation =
      glm::rotate(angle * _straighteningForce * dt, _upDirection);
...
void Ship::updateDirectionsAndPositions(float dt) {
  ...
  glm::vec3 velocityDirection =
      glm::rotate(_currentTurningAngle, _upDirection) *
      glm::vec4{_shipForward, 0.0f};
  glm::vec3 visualTurningDirection =
      glm::rotate(_currentTurningAngle * 0.5f, _upDirection) *
      glm::vec4{_shipForward, 0.0f};
  move((velocityDirection * _velocity -
        glm::dot(_shipForward, velocityDirection * _velocity) * _shipForward) *
       dt);                             // Move right/left
  move(_shipForward * _velocity * dt);  // Move forward

  if (_jumping && glm::dot((_meshPosition() - getPosition()), _upDirection) <
                      _velocity * 0.12f) {
    _jumping = false;
  }

  _meshSpringValue.setTarget(_jumping ? 5.0f : 100.0f);
  _meshSpringValue.update(dt);
  ...
  _meshUpDirection.setTarget(
      glm::rotate(-_currentTurningAngle * 0.6f, _shipForward) *
      glm::vec4{_upDirection, 0.0f});
...
void Ship::trackSurface(float dt) {
  ...
  Ray atShipRay{getPosition() + _upDirection * _rayHeight, -_upDirection,
                1000.0f};
  ...
  for (unsigned i = 0; i < _segmentsToTest.size(); ++i) {
    ...
    if (at &&
        (!atShipIntersection || at._length < atShipIntersection._length)) {
  ...
  if (atShipIntersection) {
    ...
    _shipForward = glm::normalize(
        _shipForward - glm::dot(_shipForward, _upDirection) * _upDirection);

    // Move up/down to the correct track height
    setPosition(atShipIntersection._position +
                _upDirection * (_preferredHeight));
  }
}
...
void Ship::handleLightsAndParticles(float dt) {
  ...
  if (_timeUntilIntensityUpdate <= 0.0f) {
    _timeUntilIntensityUpdate +=
        0.02f + (static_cast<float>(rand()) / RAND_MAX) * 0.06f;
    _intensityOffset.setTarget(static_cast<float>(rand()) / RAND_MAX);
  }

  _intensityOffset.update(dt);

  _engineLight.changeIntensity(powf(_velocity * 0.02f, 1.1f) * 0.2f +
                               _intensityOffset() * _velocity * 0.015f);
  _engineLight.updateColor(_shipColor * (1.0f - interpolation) +
                           glm::vec3{0.3f} * interpolation);
  _engineLight.setPosition(_transformMatrix *
                           glm::vec4{0.0f, 0.0f, -1.8f, 1.0f});

  // Warning light
  float dangerLevel = std::max((_engineTemperature - _warningLevel) /
                                   (_overheatTemperature - _warningLevel),
                               0.0f);
  ...
  if (_engineCooldown > 0.0f) {
    ...
    _warningLight.changeIntensity(std::max(
        _warningLightIntensity *
            (powf(sinf(_warningAccumulator), 5.0f) + 1.0f) / 2.0f * dangerLevel,
        0.3f));
  }

  _warningLight.setPosition(_transformMatrix *
                            glm::vec4{0.0f, 1.0f, 0.0f, 1.0f});

  // Engine particles
  _particleSystem.setBirthColor(_shipColor * (1.0f - interpolation) +
                                glm::vec3{0.3f} * interpolation);
  ...
  if (sinf(_engineBlinkAccumulator) > 0.0f &&
      (dangerLevel > 0.0f || _engineCooldown > 0.0f)) {
    _particleSystem.setBirthColor(glm::vec3{0.1f});
    _particleSystem.setBirthSize(sinf(_engineBlinkAccumulator));
  }

  _particleSystem.update(dt,
                         _transformMatrix * glm::vec4{0.0f, 0.0f, -1.3f, 1.0f},
                         -_meshForwardDirection() * (_velocity * 1.0f));

  // Chemtrail particles
  _leftChemtrailParticleSystem.setBirthColor(glm::vec3(0.05f));
  _leftChemtrailParticleSystem.setDeathColor(glm::vec3(0.0f));
  _leftChemtrailParticleSystem.setBirthSize(
      clamp(_velocity - 180.f, 0.f, 15.f) * 0.01f);
  _rightChemtrailParticleSystem.setBirthColor(glm::vec3(0.05f));
  _rightChemtrailParticleSystem.setDeathColor(glm::vec3(0.0f));
  _rightChemtrailParticleSystem.setBirthSize(
      clamp(_velocity - 180.f, 0.f, 15.f) * 0.01f);

  _leftChemtrailParticleSystem.update(
      dt, _transformMatrix * glm::vec4{-1.28f, -0.42f, -1.2f, 1.0f},
      -_meshForwardDirection() * (_velocity * 0.5f));
  _rightChemtrailParticleSystem.update(
      dt, _transformMatrix * glm::vec4{1.28f, -0.42f, -1.2f, 1.0f},
      -_meshForwardDirection() * (_velocity * 0.5f));
}

bool Ship::getOverload(float dt) { return false; }
...
void Ship::start() { _stopped = false; }
void Ship::stop() { _stopped = true; }
void Ship::destroy() { _destroyed = true; }
void Ship::repair() { _destroyed = false; }

bool Ship::getStopped() { return _stopped; }

void Ship::setReturnPos(const glm::vec3& returnPos) { _returnPos = returnPos; }

const glm::vec3& Ship::getMeshPosition() const { return _meshPosition(); }

const glm::vec3& Ship::getMeshForward() const {
  return _meshForwardDirection();
}

const glm::vec3& Ship::getMeshUp() const { return _meshUpDirection(); }

const glm::vec3 Ship::getVelocity() const {
  return _velocity * _meshForwardDirection();
}

glm::vec3 Ship::getCameraUp() { return _cameraUpDirection(); }

const glm::vec3 Ship::getCameraForward() const {
  return glm::normalize(
      _cameraForwardDirection() -
      _cameraUpDirection() * 1.0f * _surfaceSlope() -
      std::max(_inactiveTimer / _inactiveAtStart, 0.0f) *
          glm::cross(_cameraUpDirection(), _cameraForwardDirection()) * 0.3f);
}

const glm::vec3 Ship::getCameraPosition() const {
  return _meshPosition() -
         _cameraForwardDirection() * (6.0f - abs(_surfaceSlope()) * 1.0f) +
         _cameraUpDirection() * (2.0f + _surfaceSlope() * 5.0f) +
         std::max(_inactiveTimer / _inactiveAtStart, 0.0f) *
             (_cameraUpDirection() * 20.0f +
              glm::cross(_cameraUpDirection(),
                         _cameraForwardDirection() * 9.5f) -
              _cameraForwardDirection() * 80.0f);
}

const glm::mat4& Ship::getTransform() const { return _transformMatrix; }

float Ship::getSurfaceTemperature() const { return _currentSurfaceTemperature; }
...
float Ship::getEngineTemperature() { return _engineTemperature; }

float Ship::getSpeed() { return _velocity; }

void Ship::setWaypointDifference(const glm::vec3& difference) {
  _waypointDifference = difference;
}

void Ship::setSteeringCooldown(float cooldown) { _steeringCooldown = cooldown; }

void Ship::setInactiveTime(float inactiveTime) {
  _inactiveTimer = inactiveTime;
}

float Ship::getSteeringCooldown() { return _steeringCooldown; }
...
GFX::ParticleSystem& Ship::getParticleSystem() { return _particleSystem; }

PointLight& Ship::getPointLight() { return _engineLight; }

PointLight& Ship::getWarningLight() { return _warningLight; }

const glm::vec3& Ship::getColor() { return _shipColor; }
...
const BoundingBox& Ship::getBoundingBox() const { return _boundingBox; }
...
void Ship::setShip() {
  switch (_shipId) {
    case 0:
      ...
      _shipModel = GFX::TexturedModel(ModelCache::get("ship0.kmf"),
                                      MaterialCache::get("ship0.mat"));
      break;
    case 1:
      ...
      _shipModel = GFX::TexturedModel(ModelCache::get("ship1.kmf"),
                                      MaterialCache::get("ship1.mat"));
      break;
    case 2:
      ...
      _overheatCooldown = 4.f;
      _shipModel = GFX::TexturedModel(ModelCache::get("ship2.kmf"),
                                      MaterialCache::get("ship2.mat"));
      break;
    case 3:
      _maxAcceleration = 100.f;
      _maxTurningSpeed = 30.f;
      _cooldownOnObstacleCollision = 2.f;
      _overheatTemperature = .99f;
      _overheatCooldown = 10.f;
      _shipModel = GFX::TexturedModel(ModelCache::get("ship3.kmf"),
                                      MaterialCache::get("ship3.mat"));
      break;
    default:
      _maxAcceleration = 100.f;
      _maxTurningSpeed = 20.f;
